...
import com.coin.bit.pojo.AddressInformation;
import com.coin.bit.pojo.Block;
import com.coin.bit.pojo.Info;
import com.coin.bit.pojo.LastBlock;
import com.coin.bit.pojo.Transaction;
import com.coin.bit.pojo.UsdtTransaction;



public interface UsdtcoindInterface {
	...
	public BigDecimal omni_getbalance(String address,int propertyid);
	//
	...
	public UsdtTransaction omni_gettransaction(String hash);
	...
	public List<Transaction> omni_listblocktransactions(int index);
	...
	//stop
	public String stop();
	public void walletpassphrase(String pwd,long times);
}
