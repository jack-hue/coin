 ...
 * @Description:冷钱包创建、交易
 * @author: auth    
 * @date:   2018年7月4日 下午2:22:55   
 * @Copyright: 2018 http://www.hjd123.com Inc. All rights reserved.
 */
public class ColdWallet {

//	public static String d = "/Users/yangzhengwei/Documents/eth/coldwallet";
//
//	public static String address = "0xa530d89646db11abfa701e148e87324355fc6ea7";
//
//	public static String keystore = "{\"address\":\"a530d89646db11abfa701e148e87324355fc6ea7\",\"id\":\"246e7d1d-8f31-4a3e-951d-41722213a44f\",\"version\":3,\"crypto\":{\"cipher\":\"aes-128-ctr\",\"ciphertext\":\"26d10977bc199f6b678e89d3b7c3874bab3cddda18b92c014890d80657d7cc6a\",\"cipherparams\":{\"iv\":\"beaa9a404f793e86460a1fc71a0372a8\"},\"kdf\":\"scrypt\",\"kdfparams\":{\"dklen\":32,\"n\":262144,\"p\":1,\"r\":8,\"salt\":\"f06eb3d208db1643671c6e0210789f05e6de1746252fe5b83a38618e2bd18f1e\"},\"mac\":\"0aa4f85dfecaf8203ad0ee22c47ff6fb35b8f47d8f56ddb890ef2d513a06a801\"}}\n";
//
//	public static String publicKey = "f4529331f460fa88cc14eb981baf90201e7fc709386bf2f5b9ec687639f70086";
...
//			testTokenTransaction();
	...
	public static void transaction(Web3j web3j,String address,String privateKey,String toAddress) throws IOException {
		BigInteger nonce;
		...
		String data = "";
		byte chainId = ChainId.MAINNET;//测试网络
	...
	public static void testTokenTransaction(Web3j web3j, String fromAddress, String privateKey, String contractAddress, String toAddress, double amount, int decimals) {
		BigInteger nonce;
	...
	public static String signTransaction(BigInteger nonce, BigInteger gasPrice, BigInteger gasLimit, String to,
										 BigInteger value, String data, byte chainId, String publicKey) throws IOException {
		byte[] signedMessage;
		...
		ECKeyPair ecKeyPair = ECKeyPair.create(new BigInteger(publicKey, 16));
