 ...
 * @Description:生成、导入助记词(需要比特币的jar包 可以查看pom.xml)
 * @author: auth    
 * @date:   2018年7月4日 下午2:27:57   
...
//		DeterministicSeed ds = new DeterministicSeed(secureRandom, 128, passphrase, creationTimeSeconds);
	...
	public static EthHDWallet createEthWallet(DeterministicSeed ds, String[] pathArray, String password) {
		//根私钥
