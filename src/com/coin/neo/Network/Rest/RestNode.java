package com.coin.neo.Network.Rest;
...
import com.coin.neo.sdk.info.asset.UTXO2Info;
import com.coin.neo.sdk.info.asset.UTXOInfo;
...
public class RestNode {
	...
	public Block getBlock(int height) throws RestException {
		...
		try {
			return Serializable.from(com.coin.neo.Helper.hexToBytes(rr.Result), Block.class);
