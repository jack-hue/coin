...
import com.coin.neo.Cryptography.AES;
import com.coin.neo.Cryptography.Base58;
...
import com.coin.neo.IO.Caching.TrackableCollection;
import com.coin.neo.Network.Rest.RestRuntimeException;
import com.coin.neo.sdk.helper.DataFormat;
...
//            checkCoinState();
    ...
    public Map<com.coin.neo.Core.Transaction,Integer> LoadTransactions() { return null;}
    ...
    static Block from(String ss) {
    	try {
			return Serializable.from(com.coin.neo.Helper.hexToBytes(ss), Block.class);
